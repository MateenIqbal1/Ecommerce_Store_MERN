...
function AddressCard({addressInfo , handleDeleteAddress ,handleEditAddress ,setCurrentSelectedAddress ,selectedId}){
    return (
        ...
        >
            ...
            <Button onClick={()=>handleEditAddress(addressInfo)} className=" bg-[#008080] text-white hover:bg-[#FF0000]">Edit</Button>
            <Button onClick={()=>handleDeleteAddress(addressInfo)} className=" bg-[#008080] text-white hover:bg-[#FF0000]">Delete</Button>
            </CardFooter>
        </Card>
    )
}
